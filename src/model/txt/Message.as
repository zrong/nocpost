package model.txt
{
	...
	public class Message
	{
		...
		public static const LABEL_STEP_INTRODUCE:String = "<font size='14' color='#ff0000'><b>第三步：作品概要</b></font>";
		public static const LABEL_STEP_REMARK:String = "<font size='14' color='#ff0000'><b>第四步：备注</b><br>若作品联系人不是作者本人，可在此注明联系人的通讯方式</font>";;
		public static const LABEL_STEP_IDEA:String = "<font size='14' color='#ff0000'><b>第三步：创作思想</b></font><br>解释作品创作的背景、目的和意义列、列明哪些部分属自己原创";
		public static const LABEL_STEP_PROCESS:String = "<font size='14' color='#ff0000'><b>第四步：创作过程</b></font><br>解释运用了哪些技术或技巧完成主题创作";
		public static const LABEL_STEP_LITERATURE:String = "<font size='14' color='#ff0000'><b>第五步：参考资源</b></font><br>详细列明参考或引用他人资源的出处";
		public static const LABEL_STEP_UPLOAD_TEACHER:String = "<font size='14' color='#ff0000'><b>第五步:上传文件（完成）</b>";
		public static const LABEL_STEP_UPLOAD_STUDENT:String = '';
